...
extension CAPSPageMenu {
    ...
    func configureUserInterface() {
        ...
        if configuration.useMenuLikeSegmentedControl {
            ...
            selectionIndicatorFrame = CGRect(x: configuration.menuMargin, y: configuration.menuHeight - configuration.selectionIndicatorHeight-5, width: menuItemWidths[0], height: configuration.selectionIndicatorHeight-2)
        } else {

...
class MessageView: UIView {
    ...
    @objc class func hide(){
        ...
        let keyWindow = sceneDelegate?.window
        isShown = false
    ...
    class func showMessage(message:String, time:Float, textAlignment:NSTextAlignment, verticalAlignment:VerticalContenerAlignment) {
        ...
        if !isShown! {
            ...
            mesageLbl.font = UIFont.init(name: "Poppins-Regular", size: 13)
            ...
            containerView.backgroundColor = RGBA(r: 43, g: 53, b: 62, a: 1.0)//RGBA(r: 220, g: 220, b: 200, a: 1.0)
